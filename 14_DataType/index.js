...
// primitive value: number, string, boolen, null, underfined
...
// Sao chép ra 1 object mới, kế thừa tấc cả thuộc tính và phương thức của object hiện tại

// let obj2 = Object.assign({}, obj); // Cách 1
let obj2 = {...obj }; // cách này để sao chép lại cú pháp trong {name: "A", age: 18} cho ra kết quả như cách 1 nhưng ngắn hơn
obj2.age = 25;
obj2.name = "C"
...
// Sao chép ra 1 array mới, kế thừa tấc cả phần tử cua array hiện tại
// let arr2 = arr.slice() // Cách 1
let arr2 = [...arr]; //Cách 2
arr2.push(5)
...
//Cách vieret 2 gọn hơn không cần gọi thêm hàm function
...
// Lần 1: value = 1, reselt = 0 => result + value = 1
// Lần 2: value = 2, reselt = 1 => result + value = 3
// Lần 3: value = 3, reselt = 3 => result + value = 6
// Lần 4: value = 4, reselt = 6 => result + value = 10
// Lần 5: value = 5, reselt = 10 => result + value = 15

//giá trị result là lấy kết quả của return cai phía trên đi tiếp theo
...
//YC1: Trả ra 1 mảng chỉ bao gồm tên sản phẩm
...
//YC2: Trả ra 1 mảng chỉ bao gồm các sản phẩm của Apple
let productApple = products.filter((value) => {
    return value.brand === "Apple"
})
console.log("productBrand :", productApple);
